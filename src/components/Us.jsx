export default function Us() {
    return (
        <div class="contain mx-auto py-6 sm:py-8 lg:py-12 font-exo">
            <div class="mx-auto max-w-screen-xl px-4 md:px-8">
                <div class="grid gap-8 lg:grid-cols-2 lg:gap-12">
                    ...
                    <div class="">
                        ...
                        <p class="mb-6 text-gray-500 sm:text-lg md:mb-8">
                            As your go-to for garden care, we offer an attentive service available year-round. This ensures that all your garden needs receive prompt attention, providing swift responses to both our valued clients and the thriving green spaces we passionately tend to.                       
                        </p>
