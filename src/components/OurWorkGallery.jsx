    ...
    return (
        <div className=" contain mx-auto my-12 font-exo">
            ...
            <div className="grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <img src="Gallery1.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery2.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery3.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery4.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery10.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery11.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery7.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery8.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
                <img src="Gallery9.jpg" loading="lazy" alt="Photo by Livingstone Garden Services" class="" />
            </div>
        </div>
