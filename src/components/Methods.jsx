...
export default function Methods() {
    return (
        <div class="bg-white contain py-6 sm:py-8 lg:py-12">
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <div class="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
                    <div class="flex gap-4 md:gap-6">
                        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-primary text-white shadow-lg md:h-14 md:w-14 md:rounded-xl">
                        ...
                        <div>
                            ...
                            <a href="#" class="font-bold text-primary transition duration-100 hover:text-primary-400 active:text-primary-300">More</a>
                        </div>
                    </div>
